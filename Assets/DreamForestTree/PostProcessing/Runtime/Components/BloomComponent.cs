namespace PPSEngine_one
{
    ...
    public sealed class BloomComponent : PostProcessingComponentRenderTexture<BloomModel>
    {
        ...
        {
            internal static readonly int _AutoExposure        = UnityEngine.Shader.PropertyToID("_AutoExposure");
            internal static readonly int _Threshold           = UnityEngine.Shader.PropertyToID("_Threshold");
            internal static readonly int _Curve               = UnityEngine.Shader.PropertyToID("_Curve");
            internal static readonly int _PrefilterOffs       = UnityEngine.Shader.PropertyToID("_PrefilterOffs");
            internal static readonly int _SampleScale         = UnityEngine.Shader.PropertyToID("_SampleScale");
            internal static readonly int _BaseTex             = UnityEngine.Shader.PropertyToID("_BaseTex");
            internal static readonly int _BloomTex            = UnityEngine.Shader.PropertyToID("_BloomTex");
            internal static readonly int _Bloom_Settings      = UnityEngine.Shader.PropertyToID("_Bloom_Settings");
            internal static readonly int _Bloom_DirtTex       = UnityEngine.Shader.PropertyToID("_Bloom_DirtTex");
            internal static readonly int _Bloom_DirtIntensity = UnityEngine.Shader.PropertyToID("_Bloom_DirtIntensity");
        }

        const int k_MaxPyramidBlurLevel = 16;
        readonly UnityEngine.RenderTexture[] m_BlurBuffer1 = new UnityEngine.RenderTexture[k_MaxPyramidBlurLevel];
        readonly UnityEngine.RenderTexture[] m_BlurBuffer2 = new UnityEngine.RenderTexture[k_MaxPyramidBlurLevel];
        ...
        public void Prepare(UnityEngine.RenderTexture source, UnityEngine.Material uberMaterial, UnityEngine.Texture autoExposure)
        {
