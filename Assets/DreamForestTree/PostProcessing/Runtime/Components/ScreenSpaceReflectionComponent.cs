...
namespace PPSEngine_one
{
    ...
    public sealed class ScreenSpaceReflectionComponent : PostProcessingComponentCommandBuffer<ScreenSpaceReflectionModel>
    {
        ...
        {
            internal static readonly int _RayStepSize                = UnityEngine.Shader.PropertyToID("_RayStepSize");
            internal static readonly int _AdditiveReflection         = UnityEngine.Shader.PropertyToID("_AdditiveReflection");
            internal static readonly int _BilateralUpsampling        = UnityEngine.Shader.PropertyToID("_BilateralUpsampling");
            internal static readonly int _TreatBackfaceHitAsMiss     = UnityEngine.Shader.PropertyToID("_TreatBackfaceHitAsMiss");
            internal static readonly int _AllowBackwardsRays         = UnityEngine.Shader.PropertyToID("_AllowBackwardsRays");
            internal static readonly int _TraceBehindObjects         = UnityEngine.Shader.PropertyToID("_TraceBehindObjects");
            internal static readonly int _MaxSteps                   = UnityEngine.Shader.PropertyToID("_MaxSteps");
            internal static readonly int _FullResolutionFiltering    = UnityEngine.Shader.PropertyToID("_FullResolutionFiltering");
            internal static readonly int _HalfResolution             = UnityEngine.Shader.PropertyToID("_HalfResolution");
            internal static readonly int _HighlightSuppression       = UnityEngine.Shader.PropertyToID("_HighlightSuppression");
            internal static readonly int _PixelsPerMeterAtOneMeter   = UnityEngine.Shader.PropertyToID("_PixelsPerMeterAtOneMeter");
            internal static readonly int _ScreenEdgeFading           = UnityEngine.Shader.PropertyToID("_ScreenEdgeFading");
            internal static readonly int _ReflectionBlur             = UnityEngine.Shader.PropertyToID("_ReflectionBlur");
            internal static readonly int _MaxRayTraceDistance        = UnityEngine.Shader.PropertyToID("_MaxRayTraceDistance");
            internal static readonly int _FadeDistance               = UnityEngine.Shader.PropertyToID("_FadeDistance");
            internal static readonly int _LayerThickness             = UnityEngine.Shader.PropertyToID("_LayerThickness");
            internal static readonly int _SSRMultiplier              = UnityEngine.Shader.PropertyToID("_SSRMultiplier");
            internal static readonly int _FresnelFade                = UnityEngine.Shader.PropertyToID("_FresnelFade");
            internal static readonly int _FresnelFadePower           = UnityEngine.Shader.PropertyToID("_FresnelFadePower");
            internal static readonly int _ReflectionBufferSize       = UnityEngine.Shader.PropertyToID("_ReflectionBufferSize");
            internal static readonly int _ScreenSize                 = UnityEngine.Shader.PropertyToID("_ScreenSize");
            internal static readonly int _InvScreenSize              = UnityEngine.Shader.PropertyToID("_InvScreenSize");
            internal static readonly int _ProjInfo                   = UnityEngine.Shader.PropertyToID("_ProjInfo");
            internal static readonly int _CameraClipInfo             = UnityEngine.Shader.PropertyToID("_CameraClipInfo");
            internal static readonly int _ProjectToPixelMatrix       = UnityEngine.Shader.PropertyToID("_ProjectToPixelMatrix");
            internal static readonly int _WorldToCameraMatrix        = UnityEngine.Shader.PropertyToID("_WorldToCameraMatrix");
            internal static readonly int _CameraToWorldMatrix        = UnityEngine.Shader.PropertyToID("_CameraToWorldMatrix");
            internal static readonly int _Axis                       = UnityEngine.Shader.PropertyToID("_Axis");
            internal static readonly int _CurrentMipLevel            = UnityEngine.Shader.PropertyToID("_CurrentMipLevel");
            internal static readonly int _NormalAndRoughnessTexture  = UnityEngine.Shader.PropertyToID("_NormalAndRoughnessTexture");
            internal static readonly int _HitPointTexture            = UnityEngine.Shader.PropertyToID("_HitPointTexture");
            internal static readonly int _BlurTexture                = UnityEngine.Shader.PropertyToID("_BlurTexture");
            internal static readonly int _FilteredReflections        = UnityEngine.Shader.PropertyToID("_FilteredReflections");
            internal static readonly int _FinalReflectionTexture     = UnityEngine.Shader.PropertyToID("_FinalReflectionTexture");
            internal static readonly int _TempTexture                = UnityEngine.Shader.PropertyToID("_TempTexture");
        }
